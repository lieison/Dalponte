...
class CS_Widget_Recent_Posts_V1 extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget cs-recent-post-v1', 'description' => __( "Your site&#8217;s most recent Posts.",THEMENAME) );
		parent::__construct('recent-posts-v1', __('CS Recent Posts V1',THEMENAME), $widget_ops);
