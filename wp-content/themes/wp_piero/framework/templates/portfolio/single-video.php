<?php
	global $portfolio_category, $portfolio_layout,$portfolio_gallery, $portfolio_about_project, $portfolio_project_date, $portfolio_project_client, $link;
?>
<article id="cs_post_<?php the_ID(); ?>" <?php post_class('single-post format-gallery single-gallery'); ?>>
		...
		<div class="">
			<div class="cs-portfolio-gallery single-post-gallery">
				<?php echo apply_filters('the_content',$portfolio_gallery);?>
			</div>
	    </div>
</article>