<?php global $smof_data, $header_setings, $post;    $data_parallax = $c_pageID = null;    if($post){        $c_pageID = $post->ID;    }    
	...
	<div class="header-wrapper header-small-logo">
		...
		<div id="cshero-header" class="stripe-parallax-bg <?php if($smof_data['header_fixed_top']){ echo ' transparentFixed header-'.$smof_data['header_position'].'';} ?>"<?php echo $data_parallax; ?>>         
			...
			<div class="<?php echo ($smof_data['header_full_width'])?'no-container':'container';?>">            
				<div class="row">                
					<div class="logo logo-line-height-nav col-xs-6 col-sm-6 col-md-1 col-lg-1 <?php echo 'text-'.$smof_data["logo_alignment"];?>">                    
						<a href="<?php echo esc_url(home_url()); ?>">                        
							<img src="<?php echo esc_url($smof_data['logo']['url']); ?>" alt="<?php esc_attr(bloginfo('name')); ?>" 
								class="normal-logo logo-v1"/>                    
						</a>                
					</div>                
					<div id="menu" class=" main-menu-wrap col-xs-6 col-sm-6 col-md-11 col-lg-11">                    
...
<div class="header-small-logo">
	<div id="header-sticky" class="sticky-header ">
	    <div class="<?php echo ($smof_data['sticky_header_full_width'])?'no-container':'container';?>">
	        <div class="row">
	            <div class="cshero-logo logo-sticky col-xs-6 col-sm-6 col-md-1 col-lg-1">
	                <a href="<?php echo home_url(); ?>">
	                    <img src="<?php echo $smof_data['logo_header_sticky']['url']; ?>" alt="<?php bloginfo('name'); ?>" class="sticky-logo" />
	                </a>
	            </div>
	            <div class="sticky-menu-wrap col-xs-6 col-sm-6 col-md-11 col-lg-11">
