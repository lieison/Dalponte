...
<div class="cshero-portfolio-container" style="margin-right:<?php echo $item_margin; ?>;margin-bottom:<?php echo $item_margin; ?>;">
    <article <?php post_class(); ?>>
        <div class="cshero-portfolio-item-content cshero-image">
            <?php
            ...
            ?>
            <div class="cshero-portfolio-content-wrap overlay from-center" style="background-color:<?php echo $item_bg_color; ?>;">
                <div class="cshero-portfolio-content-wrap-inner overlay-content">
        ...
        <div class="cshero-portfolio-meta-box">
            ...
            if ($show_category) {
                echo '<div class="cshero-portfolio-category">'.__('in ',THEMENAME) . get_the_term_list($wp_query->post->ID, 'portfolio_category', '', ', ', '') . '</div>';
            }
            ?>
        </div>
