<div class="cs-eventCount">
	...
	<div class="cs-eventCount-content">
		...
		<div class="cs-eventCount-contentWrap col-xs-12 col-sm-12 col-md-12 col-lg-12">
		    <h1 class="cs-eventCount-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h1>
			...
			<span id="event_countdown" class="" data-count="<?php echo date('Y-m-d H:i:s', $time_next); ?>" data-label="<?php echo __('DAYS', CSCORE_NAME).','.__('HOURS', CSCORE_NAME).','.__('MINUTES', CSCORE_NAME).','.__('SECONDS', CSCORE_NAME); ?>" data-style="<?php echo esc_attr($number_position); ?>" ></span>
		</div>
		<?php endwhile; ?>
	</div>
</div>