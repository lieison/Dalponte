<script type="text/javascript">
    jQuery(document).ready(function(){
        var wrap = jQuery('#<?php echo esc_attr($fancybox_id); ?>');
        wrap.css('height', wrap.find('.cshero-fancybox-front').outerHeight());
    });
</script>
<div id="<?php echo esc_attr($fancybox_id); ?>" class="cshero-fancybox-wrap  clearfix <?php echo esc_attr($fancy_wrap.' '.$custom_class.' '.$content_align.' '.$animate_class); ?>" >
    <style type="text/css" scoped>
        ...
        <?php if ( isset( $box_border_hover ) && $box_border_hover ) : ?>
            #<?php echo esc_attr($fancybox_id); ?>:hover .cshero-fancybox-front {
    ...
    <div class="cshero-fancybox-front" <?php echo $box_style;?>>
