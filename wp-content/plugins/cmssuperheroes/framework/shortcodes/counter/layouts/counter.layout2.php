<div id="<?php echo $counter_id ?>" class="cshero-counter-wrap <?php echo str_replace(".","-",$layout); ?>">
	<?php if ($border_color_hover || $background_color_hover) : ?>
		<style type="text/css" scoped>
			#<?php echo $counter_id ?> .cshero-counter-inner .cshero-counter-primary:hover {
	...
	<div class="cshero-counter-inner <?php echo $align; ?>" >
		...
		<?php endif; ?>
		<div class="cshero-counter-primary" <?php echo $wrap_style; ?>>
