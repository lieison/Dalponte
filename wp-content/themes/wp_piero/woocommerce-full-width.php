...
<?php $layout = cshero_generetor_layout();?>
    <div id="primary" class="content-area woocommerce-page <?php if($breadcrumb == '0'){ echo ' no_breadcrumb_page'; }; ?><?php echo esc_attr($layout->class); ?>">
            ...
            <div class="row">
                ...
                <div class="content-wrap <?php echo esc_attr($layout->blog); ?>">
                    <main id="main" class="site-main" role="main">
                        <?php if(is_active_sidebar('woocommerce_wg_full_width')):?>
                            <div class="cshero-woocommerce-full-width clearfix">
                                <?php dynamic_sidebar('woocommerce_wg_full_width'); ?>
                            </div>
                        <?php endif; ?>
