<article <?php  post_class('row'); ?> style="background-color:<?php echo $item_bg_color;?>;">
    <?php if (has_post_thumbnail() and wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'full', false)) { ?>
        <div class="cshero-portfolio-carousel-item-image col-xs-12 col-sm12 col-md-6 col-lg-6 no-padding-all nopaddingall <?php if($counter%2 != '1') echo 'right';?>">
            <?php if($crop_image == 1){
    ...
    <?php } else { ?>
    	...
    	?>
    	<div class="cshero-portfolio-carousel-item-image no-image col-xs-12 col-sm12 col-md-6 col-lg-6 no-padding-all nopaddingall">
    		<?php if($crop_image == 1){ ?>
    ...
    <?php } ?>
    <div class="cshero-portfolio-carousel-item-content col-xs-12 col-sm12 col-md-6 col-lg-6">
        <div class="cshero-portfolio-carousel-item-content-inner" style="padding:<?php echo $content_padding;?>; color:<?php echo $item_content_color;?>;">
    ...
    <div class="overlay <?php echo $overlay_appear; ?>" <?php echo $overlay_style; ?>></div>
