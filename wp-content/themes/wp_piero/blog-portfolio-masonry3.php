<?php
/*
Template Name: Portfolio Masonry Layout 3
*/
get_header(); ?>
...
<?php $layout = cshero_generetor_layout();?>
    <section id="primary" class="content-area blog-masonry layout3 <?php echo $masonry_columns>1?'grid':''?> <?php if($breadcrumb == '0'){ echo ' no_breadcrumb_page'; }; ?><?php echo esc_attr($layout->class); ?>">
                    ...
                    <main id="main" class="site-main" role="main">
                        ...
                        <?php if ( $post_list->have_posts() ) : ?>
                            ...
                            ?>
                                 ...
                                 */
                                get_template_part( 'framework/templates/blog/portfolio/blog-layout3',get_post_format());
                                ?>
                                </div>
                            <?php endwhile; ?>
                        </div>
