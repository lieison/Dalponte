...
function cs_theme_register_required_plugins() {
    ...
    $plugins = array(
        array(
            'name' => 'Newsletter',
            'slug' => 'newsletter',
            'source' => 'https://downloads.wordpress.org/plugin/newsletter.zip',
            'required' => false
        ),array(
            'name' => 'Contact Form 7',
            'slug' => 'contact-form-7',
            'source' => 'https://downloads.wordpress.org/plugin/contact-form-7.4.0.1.zip',
            'required' => false
        ),
        array(
            'name' => 'woocommerce',
            'slug' => 'woocommerce',
            'source' => 'http://cmssuperheroes.com/plugins/woocommerce.zip',
            'required' => false
        ),
        array(
