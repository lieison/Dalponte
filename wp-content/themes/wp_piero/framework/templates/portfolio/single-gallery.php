<?php
global $portfolio_category, $portfolio_layout,$portfolio_gallery, $portfolio_about_project, $portfolio_project_date, $portfolio_project_client, $link, $gallery_layout, $gallery;
?>
