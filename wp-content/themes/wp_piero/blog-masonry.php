...
<?php
    ...
    $masonry_columns   = ($masonry_columns)?$masonry_columns:3;
    $masonry_loadmore = (get_post_meta(get_the_ID(),'cs_page_masonry_loadmore',true)=='yes')?true:false;
    $masonry_loadmore   = ($masonry_loadmore)?$masonry_loadmore:true;
...
<?php $layout = cshero_generetor_layout();?>
    <section id="primary" class="content-area blog-masonry<?php if($breadcrumb == '0'){ echo ' no_breadcrumb_page'; }; ?><?php echo esc_attr($layout->class); ?> blog-grid">
