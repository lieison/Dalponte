<article  <?php  post_class(); ?>>
    ...
    <div class="cshero-portfolio-carousel-item-content" <?php echo $item_style;?>>
        <div class="cshero-portfolio-carousel-item-content-inner">
            ...
            <?php } ?>
            <?php if($show_read_more == '1' || $show_popup == '1' || $portfolio_link!='') :?>
                <div class="cshero-portfolio-link-wrap">
                    <div class="cshero-portfolio-link-inner">
                        <?php if($portfolio_link!='' && $show_link == '1'){ ?>
                            <a class="btn btn-white" href="<?php echo  esc_url($portfolio_link); ?>" title="<?php the_title(); ?>" target="_blank">
                                <i class="fa fa-external-link"></i>
                            </a>
                        <?php } ?>
                        <?php if($show_read_more == '1') :?>
                            <a class="btn btn-white" title="<?php the_title(); ?>" href="<?php the_permalink(); ?>" >
                                <i class="fa fa-link"></i>
                            </a>
                        <?php endif;?>
                        <?php if($show_popup == '1') :?>
                            <a class="colorbox btn btn-white" title="<?php the_title(); ?>" href="<?php echo esc_url($attachment_full_image); ?>" >
