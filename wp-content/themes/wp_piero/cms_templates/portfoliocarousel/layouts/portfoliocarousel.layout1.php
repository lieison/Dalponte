                        ...
                        <div class="cshero-portfolio-link-wrap">
                            <div class="cshero-portfolio-link-inner">
                                <?php if($portfolio_link !='' && $show_link){ ?>
                                    <a class="" style="color:<?php echo $item_content_color;?>" href="<?php echo  esc_url($portfolio_link); ?>" title="<?php the_title(); ?>" target="_blank">
                                        <i class="fa fa-external-link"></i>
                                    </a>
                                <?php } ?>
                                <?php if($show_read_more) :?>
                                    <a class="" style="color:<?php echo $item_content_color;?>" title="<?php the_title(); ?>" href="<?php the_permalink(); ?>" >
                                        <i class="fa fa-link"></i>
                                    </a>
                                <?php endif;?>
                                <?php if($show_popup) :?>
                                    <a class="colorbox" style="color:<?php echo $item_content_color;?>" title="<?php the_title(); ?>" href="<?php echo esc_url($attachment_full_image); ?>" >
