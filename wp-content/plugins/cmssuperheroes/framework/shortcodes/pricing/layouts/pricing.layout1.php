...
<?php if ( !has_post_thumbnail() ) : ?>
    <style type="text/css" scoped>
        ...
        #cs_pricing_<?php echo esc_attr($date); ?> .cs-pricing-item .cs-pricing-container { border-color:<?php echo $title_background_pricing_color; ?>;}
        #cs_pricing_<?php echo esc_attr($date); ?> .cs-pricing-item.cs-pricing-feature  .cs-pricing-container {border-color: <?php echo $content_background_pricing_color; ?>;}
